...
class CloudAdmin:
    def do_dns_update(self, zone_id: str, target: str, record: str, record_type: str, proxy: bool = True):
    ...
    def ddns(self, dns_name: str):
        ...
        self.do_dns_update(self.get_zone_id(dns_name), dns_name, ip_address, ip_address_type,False)
